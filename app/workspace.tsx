...
export default function Workspace({signedIn}:{signedIn:boolean}) {
 ...
 return <div className="app-shell">
  ...
  {!signedIn&&<div className="notice">가져온 영수증을 내 공간에 보관할 수 있도록 먼저 <a href={signInPath('/')} target="_top">로그인해 주세요.</a></div>}
