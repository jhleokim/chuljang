import { z } from 'zod';
export const sourceIds = ['ktx','kakaot','tmoney','airline','socar'] as const;
export type Source = typeof sourceIds[number];
export const sourceNames: Record<Source,string> = {ktx:'KTX · 코레일',kakaot:'카카오 T',tmoney:'티머니 · 고속버스',airline:'항공',socar:'쏘카'};
