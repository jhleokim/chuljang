...
{id:'transit',name:'티머니 · 지하철·시내버스',mode:'회원 내역 자동 조회',color:'#c76221',url:'https://pay.tmoney.co.kr/ncs/pct/mtmn/ReadTrprInqr.dev',steps:['티머니 계정에 등록된 선불·모바일 교통카드가 대상입니다.','공식 조회 기간은 조회일 기준 367일 전부터 2일 전까지입니다.','신용·체크카드의 후불교통 내역은 발행 카드사에서 제공됩니다.'],note:'홈서버에서 등록 카드와 조회 페이지를 순회합니다. 실제 회원 계정의 최종 대조는 아직 필요합니다. 저장하는 PDF는 공식 조회 내역의 사본입니다.'},
...
{id:'tmoney',name:'고속버스 · KOBUS',mode:'회원 내역 자동 조회',color:'#ba3060',url:'https://www.kobus.co.kr/mbrs/trprinqr/pymPtInqr.do',steps:['출장 날짜를 선택하고 KOBUS에 로그인할 수 있습니다.','로그인 후 조회 가능한 결제내역에서 실제 이용일에 맞는 건을 찾습니다.','이미 발급받은 영수증 이미지나 PDF는 가져올 수 있습니다.'],note:'홈서버에 회원 조회 어댑터를 구현했습니다. 실제 회원 화면 대조는 아직 필요하며, 왕복 금액처럼 날짜별 배분이 불명확한 건은 완료로 처리하지 않습니다.'},
